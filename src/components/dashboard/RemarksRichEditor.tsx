    ...
    >
          ...
          {block.type === "text" ? (
            <div className="min-w-0 flex-1">
              <textarea
                ...
                className="w-full resize-y rounded-md border border-border bg-background px-2 py-1 font-body text-[11px] leading-snug text-foreground placeholder:text-muted-foreground/40 focus:border-primary/50 focus:outline-none focus:ring-1 focus:ring-primary/30"
              />
            </div>
          ) : (
      ...
      <div className="flex flex-wrap items-center gap-1 pt-0.5">
        <button
          ...
          className="inline-flex items-center gap-0.5 rounded px-1 py-0.5 font-body text-[10px] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
          title="新增文字區塊"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-0.5 rounded px-1 py-0.5 font-body text-[10px] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground disabled:cursor-not-allowed disabled:opacity-40"
        ...
        <button
          ...
          onClick={() => fileRef.current?.click()}
          disabled={imageCount >= MAX_REMARKS_IMAGES}
          className="inline-flex items-center gap-0.5 rounded px-1 py-0.5 font-body text-[10px] text-primary/70 transition-colors hover:bg-primary/5 hover:text-primary disabled:cursor-not-allowed disabled:opacity-40"
          title="上傳或貼上圖片"
        >
