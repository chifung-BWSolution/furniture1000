...
-- design_projects
INSERT INTO design_projects (id, name, client_name, client_company, status, active_scheme, progress, created_by, created_at, updated_at) VALUES
  ('11111111-1111-1111-1111-111111111111', '匯豐中環辦公室翻新', '陳大文', '匯豐銀行', 'in_progress', 'A', 62, 'CF', '2026-05-12T09:00:00Z', '2026-06-01T14:20:00Z'),
  ('22222222-2222-2222-2222-222222222222', '科技園共享辦公空間', '李小芳', 'StartHub', 'confirmed', 'B', 100, 'CF', '2026-04-20T09:00:00Z', '2026-05-28T10:00:00Z'),
  ('33333333-3333-3333-3333-333333333333', '尖沙咀精品酒店大堂', '黃經理', '半島集團', 'draft', 'A', 15, 'CF', '2026-05-30T09:00:00Z', '2026-06-02T08:00:00Z')
ON CONFLICT (id) DO NOTHING;

-- project_zones
INSERT INTO project_zones (id, project_id, code, name, bounds, ai_suggested, sort_order) VALUES
  ('aaaaaaaa-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'B1', '老闆區', '{"x":6,"y":8,"w":34,"h":40}', true, 0),
  ('aaaaaaaa-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'M1', '會議室', '{"x":46,"y":8,"w":30,"h":32}', true, 1),
  ('aaaaaaaa-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'O1', '開放辦公區', '{"x":6,"y":54,"w":70,"h":38}', true, 2)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO product_discussions (id, project_id, zone_product_id, author, author_role, body, mentions, created_at) VALUES
  ('eeeeeeee-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'bbbbbbbb-0000-0000-0000-000000000002', '陳大文', 'client', '座椅顏色可否換成深啡色？ @設計師', ARRAY['設計師'], '2026-05-30T10:00:00Z'),
